...
describe('/api/genres', () => {
    ...
    describe('POST /', () => {
        ...
        it('should return 400 error if genre is less than 5 letters', async () => {
            name = '1234';
            const res = await exec();
        ...
        it('should return 400 error if genre is more than 50 letters', async () => {
            //name with more than 50 character
            name = new Array(52).join('a'); //this will put 'a' between each element.
        ...
        it('should return a genre if is valid', async () => {
